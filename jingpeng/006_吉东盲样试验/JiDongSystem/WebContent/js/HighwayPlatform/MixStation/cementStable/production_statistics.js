...
function getList() {
	...
	$.ajax({
				type : "post",
				url : "../../platformCementStableStatistics/getPlatformCementStableStatisticsChars.action",
				data : {
			...
			.DataTable(
					{
						...
						"ajax" : {
							type : "post",
							url : "../../platformCementStableStatistics/getPlatformCementStableStatistics.action",
							dataSrc : "data",
							data : function(d) {
								var param = {};
			...
			.DataTable(
					{
						...
						"ajax" : {
							type : "post",
							url : "../../platformCementStableStatistics/getPlatformCementStableStatisticsDetail.action",
							dataSrc : "data",
							data : function(d) {
								var param = {};
								param.startTime = startTime + " " + "00:"
