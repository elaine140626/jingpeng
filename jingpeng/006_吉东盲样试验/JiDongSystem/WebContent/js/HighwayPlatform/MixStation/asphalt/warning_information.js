...
function getList(){
	...
	$.ajax({
				type : "post",
				url : "../../PlatformAsphaltWarningInformation/getPlatformAsphaltWarningInformationChars.action",
				data : {
	...
	$('#Asphalt_warning').DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../../PlatformAsphaltWarningInformation/getPlatformAsphaltWarningInformation.action",
            dataSrc: "data",
            data: function (d) {
                var param = {};
        ...
        "columns" : [ {
            ...
            render: function(data, type, row, meta) {   
            	return "<span><a href='production_data_href.html?startTime="+startTime+"&endTime="+endTime+"&org_ID="+org_ID +"&Analysis_Result=0' target='_blank'>"+data+"</a></span>";
	        }
        }, {
            "data" : "unqualified",
            render: function(data, type, row, meta) {   
            	return "<span><a href='production_data_href.html?startTime="+startTime+"&endTime="+endTime+"&org_ID="+org_ID +"&Analysis_Result=2' target='_blank''>"+data+"</a></span>";
	        }
        }, {
            "data" : "glunqualified"
        }, {
...
function detailed(data){
	...
	$('#alertdetail').DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../../PlatformAsphaltWarningInformation/getPlatformAsphaltWarningInformationDetail.action",
            dataSrc: "data",
            data: function (d) {
                var param = {};
                param.startTime = startTime +" "+"00:"+"00:"+"00";
