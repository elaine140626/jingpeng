...
function getList() {
	...
	$.ajax({
				type : "post",
				url : "../../PlatformCementStatistics/getPlatformCementStatisticsChars.action",
				data : {
			...
			.DataTable(
					{
						...
						"ajax" : {
							type : "post",
							url : "../../PlatformCementStatistics/getPlatformCementStatistics.action",
							dataSrc : "data",
							data : function(d) {
								var param = {};
			...
			.DataTable(
					{
						...
						"ajax" : {
							type : "post",
							url : "../../PlatformCementStatistics/getPlatformCementStatisticsDetail.action",
							dataSrc : "data",
							data : function(d) {
								var param = {};
								param.startTime = startTime + " " + "00:"
