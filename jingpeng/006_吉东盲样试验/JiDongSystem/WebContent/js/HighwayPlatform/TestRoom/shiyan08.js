	...
	$.ajax({
		...
		success : function(data) {
	    	...
	    	group += "<tr>"
		              ...
		              + "<td colspan='4'><label id='avgTensileStrength'></label></td>"
		              + "</tr>"
		              + "<tr>"
		              + "<td>判定指标</td>"
		              + "<td colspan='2'>极限强度</td>"
		              + "<td colspan='4'><label id='tensileStrength'></label></td>"
				      + "</tr>" 
	    	$("#list").html(group);
