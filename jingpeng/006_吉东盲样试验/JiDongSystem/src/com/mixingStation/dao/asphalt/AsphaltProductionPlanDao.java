...
public interface AsphaltProductionPlanDao {
	
	//获取页面生产计划初始化信息
	List<AsphaltProductionPlan> getAsphaltProductionPlanInfo(Map<String , Object> map);
	
	//添加生产计划
	int addAsphaltProductionPlan(AsphaltProductionPlan data);
	
	//修改生产计划
	int updateAsphaltProductionPlan(AsphaltProductionPlan data);
	
	//删除修改计划
	int deleteAsphaltProductionPlan(Map<String,Object> map);
	
	//作废修改计划
	int zfAsphaltProductionPlan(Map<String,Object> map);
