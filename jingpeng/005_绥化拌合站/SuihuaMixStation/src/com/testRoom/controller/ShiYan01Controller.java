...
public class ShiYan01Controller{	
	 ...
	 * 
	**/	
	@RequestMapping("/getshiyan01.action")
	@ResponseBody
	 ...
	 * 
	**/	
	@RequestMapping("/getshiyan02.action")
	@ResponseBody
	 ...
	 * 
	**/	
	@RequestMapping("/getshiyan03.action")
	@ResponseBody
	public DataTablesResponseInfo getshiyan03(@RequestParam HashMap<String, Object> mapParam){	
		DataTablesResponseInfo dtri = new DataTablesResponseInfo();
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("id", mapParam.get("id"));
		List<ShiYan03Entity> list=  shiYan01Service.getShiYan03(map);
		Map<String, Object> mapDetail = new HashMap<String, Object>();
		mapDetail.put("serialnumber", list.get(0).getSerialNumber());
		List<ShiYan03DetailEntity> listDetail = shiYan01Service.getShiYanDetail03(mapDetail);
		if (listDetail!=null) {
			for(int i=0;i<listDetail.size();i++) {
				if(listDetail.get(i).getUltimateLoad1() == null) {
					listDetail.get(i).setUltimateLoad1(""); 
				...
				if(listDetail.get(i).getUltimateLoad4() == null) {
					listDetail.get(i).setUltimateLoad4(""); 
				}
				if(listDetail.get(i).getUltimateLoad5() == null) {
					listDetail.get(i).setUltimateLoad5(""); 
				}
				if(listDetail.get(i).getUltimateLoad6() == null) {
					listDetail.get(i).setUltimateLoad6(""); 
				}
				if(listDetail.get(i).getComprStrength1() == null) {
					listDetail.get(i).setComprStrength1(""); 
				}
				...
				if(listDetail.get(i).getComprStrength4() == null) {
					listDetail.get(i).setComprStrength4(""); 
				}
				if(listDetail.get(i).getComprStrength5() == null) {
					listDetail.get(i).setComprStrength5(""); 
				}
				if(listDetail.get(i).getComprStrength6() == null) {
					listDetail.get(i).setComprStrength6(""); 
				}
				if(listDetail.get(i).getCompressionStrength() == null) {
					listDetail.get(i).setCompressionStrength(""); 
				}
				if(listDetail.get(i).getProp_DesignStrength() == null) {
					listDetail.get(i).setProp_DesignStrength(""); 
				}
				...
				if(listDetail.get(i).getUltLoadImage4() == null) {
					listDetail.get(i).setUltLoadImage4(""); 
				}
				if(listDetail.get(i).getUltLoadImage5() == null) {
					listDetail.get(i).setUltLoadImage5(""); 
				}
				if(listDetail.get(i).getUltLoadImage6() == null) {
					listDetail.get(i).setUltLoadImage6(""); 
				}
			}
		}
		Map<String, Object> params = new HashMap<String, Object>();
	 ...
	 * 
	**/	
	@RequestMapping("/getshiyan04.action")
	@ResponseBody
	 ...
	 * 
	**/	
	@RequestMapping("/getshiyan05.action")
	@ResponseBody
	 ...
	 * 
	**/	
	@RequestMapping("/getshiyan06.action")
	@ResponseBody
	 ...
	 * 
	**/	
	@RequestMapping("/getshiyan07.action")
	@ResponseBody
	 ...
	 * 
	**/	
	@RequestMapping("/getshiyan08.action")
	@ResponseBody
