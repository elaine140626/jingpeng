...
||||||| .r4
		...
		//y轴(油石比%)
		List<Double> asphaltRatio2 = new ArrayList<Double>();
		//工区
		List<String> orgNameList2 = new ArrayList<String>();
		
		//三工区
		//x轴(时间)
		List<String> timeList3 = new ArrayList<String>();
		//y轴(油石比%)
		List<Double> asphaltRatio3 = new ArrayList<Double>();
		//工区
		List<String> orgNameList3 = new ArrayList<String>();
...
||||||| .r4
			//param.put("orgId", organizationList.get(i).get("id").toString());
			orgIds.add(organizationList.get(i).get("id").toString());
		}
		...
		for (int j = 0; j < asphaltList.size(); j++) {
			if(asphaltList.get(j).get("Org_Name").toString().equals("一工区沥青混合料拌合站")) {
=======
			//param.put("orgId", organizationList.get(i).get("id").toString());
			orgIds.add(organizationList.get(i).get("id").toString());
		}
...
||||||| .r4
				//工区
				orgNameList.add(asphaltList.get(j).get("Org_Name").toString());
			}else if(asphaltList.get(j).get("Org_Name").toString().equals("二工区沥青混合料拌合站")) {
				//时间
				timeList2.add(asphaltList.get(j).get("collectTime").toString());
				//油石比
				asphaltRatio2.add(Double.valueOf(asphaltList.get(j).get("asphalt").toString()));
				//工区
				orgNameList2.add(asphaltList.get(j).get("Org_Name").toString());
			}else if(asphaltList.get(j).get("Org_Name").toString().equals("三工区沥青混合料拌合站")){
				//时间
				timeList3.add(asphaltList.get(j).get("collectTime").toString());
				//油石比
				asphaltRatio3.add(Double.valueOf(asphaltList.get(j).get("asphalt").toString()));
				//工区
				orgNameList3.add(asphaltList.get(j).get("Org_Name").toString());
=======
				//工区
				orgNameList.add(asphaltList.get(j).get("Org_Name").toString());
			}else if(asphaltList.get(j).get("Org_Name").toString().equals("二工区沥青混合料拌合站")) {
...
||||||| .r4
		...
		params.put("xAxis", timeList);
		params.put("yseries", asphaltRatio);
		params.put("orgNameList", orgNameList.get(0));
		params2.put("xAxis", timeList2);
		params2.put("yseries", asphaltRatio2);
		params2.put("orgNameList", orgNameList2.get(0));
		params3.put("xAxis", timeList3);
		params3.put("yseries", asphaltRatio3);
		params3.put("orgNameList", orgNameList3.get(0));
=======
		//切换显示的数据
		...
		if(orgNameList2.size()>0) {
		params2.put("xAxis", timeList2);
		params2.put("yseries", asphaltRatio2);
		params2.put("orgNameList", orgNameList2.get(0));
		resultList.add(params2);
		}
		if(orgNameList3.size()>0) {
		params3.put("xAxis", timeList3);
		params3.put("yseries", asphaltRatio3);
		params3.put("orgNameList", orgNameList3.get(0));
>>>>>>> .r200
