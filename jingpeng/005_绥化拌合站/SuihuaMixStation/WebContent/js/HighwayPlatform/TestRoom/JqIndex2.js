        	...
        	if(data != null && data.length > 0){
        		for(var i = 0; i < data.length; i++){
        			...
        			html += "<div id='count"+(i+1)+"'>"
					        ...
					        + "<li>实验总数：<span>"+data[i].zCount+"</span></li>"
...
//						 + "<a href='#myModal' class='btn1' data-toggle='modal' onclick='getAutoCollectionList(\""+data[i].UniqueIdentifier+"\")';>点击查看详细数据</a>"
						 ...
						 + "</div>"
						 + "<div class='noIconz-pie'>"
						 + "<span class='i1'>合格实验数量：</span><span class='i3'>"+data[i].hgCount+"</span>"
						 + "</div>"
						 + "</div>"
					     + "</div>";
        			$("#" + chartId).append(html);
...
||||||| .r4
    						+ "<td style='text-align:center;vertical-align:middle;'>" + info[i].totalInfo[j].total + "（盘）" + info[i].totalInfo[j].totalWeight + "（t）</td>"
    						+ "<td style='text-align:center;vertical-align:middle;'>" + info[i].totalInfo[j].warn + "</td>"
=======
    						+ "<td style='text-align:center;vertical-align:middle;'>" + info[i].totalInfo[j].materialName + "</td>"
    						+ "<td style='text-align:center;vertical-align:middle;'>" + info[i].totalInfo[j].materialModel + "</td>"
    						+ "<td style='text-align:center;vertical-align:middle;'>" + info[i].totalInfo[j].total + "（盘）" + info[i].totalInfo[j].totalWeight + "（t）</td>"
    						+ "<td style='text-align:center;vertical-align:middle;'>" + info[i].totalInfo[j].warn + "</td>"
>>>>>>> .r200
    						+ "</tr>"
...
<<<<<<< .mine
						 ...
						 + "<td>报警盘数</td>"
||||||| .r4
						 + "<td style='text-align:center;vertical-align:middle;'>生产数量</td>"
						 + "<td style='text-align:center;vertical-align:middle;'>报警盘数</td>"
=======
						 + "<td style='text-align:center;vertical-align:middle;'>物料名称</td>"
						 + "<td style='text-align:center;vertical-align:middle;'>物料型号</td>"
						 + "<td style='text-align:center;vertical-align:middle;'>生产数量</td>"
						 + "<td style='text-align:center;vertical-align:middle;'>报警盘数</td>"
>>>>>>> .r200
						 + "</tr>"
