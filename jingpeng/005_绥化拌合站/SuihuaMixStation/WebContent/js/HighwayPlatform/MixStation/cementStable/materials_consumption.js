...
function getList(){
	...
	$.ajax({
				type : "post",
				url : "../../platformCementStableMaterialsConsumption/getPlatformCementStableMaterialsConsumptionChars.action",
				data : {
	...
	$('#ycl').DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../../platformCementStableMaterialsConsumption/getPlatformCementStableMaterialsConsumption.action",
            dataSrc: "data",
            data: function (d) {
                var param = {};
...
function detailed(data){
	...
	$('#ma').DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../../platformCementStableMaterialsConsumption/getPlatformCementStableMaterialsConsumptionDetail.action",
            dataSrc: "data",
            data: function (d) {
                var param = {};
                param.startTime = startTime +" "+"00:"+"00:"+"00";
