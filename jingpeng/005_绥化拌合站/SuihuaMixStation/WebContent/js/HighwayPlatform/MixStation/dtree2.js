...
function dTree(objName, objbool) {        // void ���췽��������������objName: �����ơ�objbool����ѡ��ѡ true��ѡ  false��ѡ  Ĭ�ϵ�ѡ         
    ...
    this.icon = {
        root:        '../../image/img/base.gif',         // Node ���ڵ㡣 
        folder:      '../../image/img/folder.gif',       // Node ���ڵ㡣 
        folderOpen:  '../../image/img/folderopen.gif',   // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        node:        '../../image/img/page.gif',         // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        empty:       '../../image/img/empty.gif',        // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        line:        '../../image/img/line.gif',         // ����,Ĭ��'img/line.gif'
        join:        '../../image/img/join.gif',         // ����,Ĭ��'img/join.gif' 
        joinBottom:  '../../image/img/joinbottom.gif',   // ֱ����,Ĭ��'img/joinbottom.gif' 
        plus:        '../../image/img/plus.gif',         // �ӺŶ���,Ĭ��'img/plus.gif' 
        plusBottom:  '../../image/img/plusbottom.gif',   // �Ӻ�ֱ����,Ĭ��'img/plusbottom.gif' 
        minus:       '../../image/img/minus.gif',        // ���Ŷ���,Ĭ��'img/minus.gif' 
        minusBottom: '../../image/img/minusbottom.gif',  // ����ֱ����,Ĭ��'img/minusbottom.gif'  
        nlPlus:      '../../image/img/nolines_plus.gif', // ����ֱ����,Ĭ��'img/minusbottom.gif' 
        nlMinus:     '../../image/img/nolines_minus.gif' //���߼���,Ĭ��'img/nolines_minus.gif' 
    };
