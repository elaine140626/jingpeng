...
function getList(){
	...
	$.ajax({
				type : "post",
				url : "../../PlatformCementWarningInformation/getPlatformCementWarningInformationChars.action",
				data : {
	...
	$('#Asphalt_warning').DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../../PlatformCementWarningInformation/getPlatformCementWarningInformation.action",
            dataSrc: "data",
            data: function (d) {
                var param = {};
...
function detailed(data){
	...
	$('#alertdetail').DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../../PlatformCementWarningInformation/getPlatformCementWarningInformationDetail.action",
            dataSrc: "data",
            data: function (d) {
                var param = {};
                param.startTime = startTime +" "+"00:"+"00:"+"00";
