...
public class ExportmeasureotherEntity {
	...
	private String TestReport; // 检测报告编写
	private Double Temperature; // 温度（°C）
	private String QualityInspector; // 检斤员
	private String MeasureTime; // 称重时间
	private Integer IsSelfMention; // 是否自提（默认否） 0:是 1:否
	private String FacingSlipNum; // 封签号
	private String FacingSlipNum2; // 封签号
	private String FacingSlipNum3; // 封签号
	private String FacingSlipNum4; // 封签号
	private String Remarks; // 备注
	private String DriverAutograph; // 司机签名图片（路径）
	private int IsDel;
