...
function addClientVisit(){
	...
	var visitContent = $("#visitContent").val();
	if(visitContent==""){
		swal("操作失败", "拜访内容不能为空", "info");
		return;
	}
	if(visitContent.length>200){
		swal("操作失败", "拜访内容过长", "info");
		return;
	}
	...
	if(cid!=""&&cid!=null){
		...
		options = {
		 ...
		 $.ajax({
	         type: "post",
	         url: baseUrl+'/ClientVisit/updateClientVisit.action',
	         async:false,
	...
	options = {
	 ...
	 $.ajax({
         type: "post",
         url: baseUrl+'/ClientVisit/addClientVisit.action',
         async:false,
         data:JSON.stringify(options),
         dataType: "json",
         contentType : 'application/json;charset=UTF-8',
...
function getVisitContent(){
	 $.ajax({
         type: "post",
         url: baseUrl+'/ClientVisit/getVisitContent.action',
         async:false,
         dataType: "json",
         contentType : 'application/json;charset=UTF-8',
         success: function (data) {
...
function getCustomerInfo(){
	 $.ajax({
        type: "post",
        url: baseUrl+'/ClientVisit/getCustomerInfo.action',
        async:false,
        dataType: "json",
        contentType : 'application/json;charset=UTF-8',
        success: function (data) {
...
function findFleetByid(id){
	$.ajax({
        type: "post",
        url: baseUrl+'/ClientVisit/getClientVisitById.action',
        async:false,
        data:{"id":id},
        dataType: "json",
        success: function (data) {
