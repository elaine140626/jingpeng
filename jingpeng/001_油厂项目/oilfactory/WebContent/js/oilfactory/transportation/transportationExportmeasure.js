...
function update(BillNumber){
		$.fancybox({
			'href': 'transportationExportmeasureAddOrUpdate.html?BillNumber='+BillNumber,
			'width': 1680,
			'height': 650,
			'type': 'iframe',
...
function del(BillNumber){
	...
	function(){
		...
		$.ajax({
	        type: "post",
	        url:  baseUrl+'/TranSportList/getUploadfile.action',
	        async:false,
	        dataType: "json",
	        success: function (data) {
		...
		$.ajax({
	        type: "post",
	        url:  baseUrl+'/TranSportList/delTranSportList.action',
	        async:false,
