...
public interface WeighingQueryOtherOutDao {
    ...
    List<WeighingQueryOtherOutEntity> ClientList(Map<String, Object> map);
	List<WeighingQueryOtherOutEntity> PlateNumberList(Map<String, Object> map);
	List<WeighingQueryOtherOutEntity> DeliveryManList(Map<String, Object> map);
	List<WeighingQueryOtherOutEntity> FleetNameList(Map<String, Object> map);
	List<WeighingQueryOtherOutEntity> MaterielNameList(Map<String, Object> map);
	List<WeighingQueryOtherOutEntity> MaterielModelList(Map<String, Object> map);
