...
public class TakeEnffect_Record extends ModelSupport{

	/**
	 * 生产生效信息表
	 */
	private static final long serialVersionUID = -1074741819549870048L;
	...
	private int i_plan_Id; //生产计划ID
	
	private String str_takeEnffec_Time; //生效时间
	
	private String str_reviser; //执行生效人
	...
	public int getI_plan_Id() {
		return i_plan_Id;
	}

	public void setI_plan_Id(int i_plan_Id) {
		this.i_plan_Id = i_plan_Id;
	}

	public String getStr_takeEnffec_Time() {
		return str_takeEnffec_Time;
	}

	public void setStr_takeEnffec_Time(String str_takeEnffec_Time) {
		this.str_takeEnffec_Time = str_takeEnffec_Time;
	}
