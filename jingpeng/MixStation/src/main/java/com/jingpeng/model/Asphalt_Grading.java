 ...
 *
 */
public class Asphalt_Grading extends ModelSupport {
	private static final long serialVersionUID = -3532332729384121657L;
	private int i_id;
	...
	List<Asphalt_GradDetailed> list; 
	...
	public List<Asphalt_GradDetailed> getList() {
		return list;
	}

	public void setList(List<Asphalt_GradDetailed> list) {
		this.list = list;
	}
