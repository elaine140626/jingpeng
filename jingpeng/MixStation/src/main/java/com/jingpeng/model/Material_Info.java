 ...
 * 材料信息
 */
public class Material_Info extends ModelSupport {
	private static final long serialVersionUID = -8507181522309326865L;
	...
	private int i_mateName_Id; // 物料名称id

	private int i_mateModel_Id; // 规格型号id

	private double d_density; // 密度

	private String str_measure_Unit; // 计量单位

	private String str_material_Type;// 物料种类

	private String str_material_Mold;// 物料类型
