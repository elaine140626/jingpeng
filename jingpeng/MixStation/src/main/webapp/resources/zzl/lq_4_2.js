$(function(){
   ...
   var a =  afterUrl.toString().split("&")
	...
	vs.os = a[0].substring(7)
    vs.start_Time = a[1].substring(11)
    vs.end_Time = a[2].substring(9)
    ...
    $('#list').DataTable(
        {
            ...
            "ajax" : {
                ...
                data: function (d) {
                    var param = {};
                    param.os = vs.os;
                    param.Analysis_Result = !1
                    param.start_Time = vs.start_Time;
                      param.end_Time = vs.end_Time;
