	...
	$('#list').DataTable(
			{
				...
				"ajax" : baseUrl+ "/AsphaltProductionData/getAsphaltProductionData.html?i_org_Id="+i_org_Id,
				"deferRender" : true,
				"columns" : [/*
				...
				"createdRow" : function(row, data, dataIndex) {
					...
					//$(row).children("td").eq(6).html("<a onMouseOver=\"Baywindow(this,"+data.i_prod_Id+");\"  onMouseOut=\"hide(this)\" id='(\""+data.i_id+"\");'>"+data.str_proportion_Code+ "</a>");
					//$(row).children("td").eq(7).html("<a href='javascript:void(0);' id='t1' onMouseOver='show2(this,\"mydiv1\","+data.i_id+");' onMouseOut='hide2(this,\"mydiv1\")'>"+data.str_grade_Code+"</a>");
    ...
    $('#list').DataTable(
			{
				...
				"ajax" : {
			        type: "post",
			        url: baseUrl+ "/AsphaltProductionData/getAsphaltProductionData.html",
			        dataSrc: "data",
			        data: function () {
			            var param = {};
