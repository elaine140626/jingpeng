...
function dTree(objName, objbool) {        // void ���췽��������������objName: �����ơ�objbool����ѡ��ѡ true��ѡ  false��ѡ  Ĭ�ϵ�ѡ         
    ...
    this.icon = {
        root:        '../resources/img/base.gif',         // Node ���ڵ㡣 
        folder:      '../resources/img/folder.gif',       // Node ���ڵ㡣 
        folderOpen:  '../resources/img/folderopen.gif',   // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        node:        '../resources/img/page.gif',         // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        empty:       '../resources/img/empty.gif',        // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        line:        '../resources/img/line.gif',         // ����,Ĭ��'img/line.gif'
        join:        '../resources/img/join.gif',         // ����,Ĭ��'img/join.gif' 
        joinBottom:  '../resources/img/joinbottom.gif',   // ֱ����,Ĭ��'img/joinbottom.gif' 
        plus:        '../resources/img/plus.gif',         // �ӺŶ���,Ĭ��'img/plus.gif' 
        plusBottom:  '../resources/img/plusbottom.gif',   // �Ӻ�ֱ����,Ĭ��'img/plusbottom.gif' 
        minus:       '../resources/img/minus.gif',        // ���Ŷ���,Ĭ��'img/minus.gif' 
        minusBottom: '../resources/img/minusbottom.gif',  // ����ֱ����,Ĭ��'img/minusbottom.gif'  
        nlPlus:      '../resources/img/nolines_plus.gif', // ����ֱ����,Ĭ��'img/minusbottom.gif' 
        nlMinus:     '../resources/img/nolines_minus.gif' //���߼���,Ĭ��'img/nolines_minus.gif' 
    };
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (node.url) {
        ...
        if (this.config.useSelection && ((node._hc && this.config.folderLinks) || !node._hc))
            str += ' onclick="javascript: ' + this.obj + '.s(' + node.pid+','+ nodeId+ ');"';
        str += '>';
    }
    else if ((!this.config.folderLinks || !node.url) && node._hc && node.pid != this.root.id)
        str += '<a href="javascript: ' + this.obj + '.o('+ node.pid+','+ nodeId+');" class="node">';
    ...
    if (node.pid == this.root.id) {
        ...
        if (node.cchecked) {
            ...
            if (this.RadioRocheckbox) {
                checkboxSyntax = "<input type='checkbox' desc='" + node.cshow + "' name='" + node.cname + "' id='" + node.cname + "_" + node.id + "' cshow='" + node.cshow + "'  value='" + node.cvalue + "' onClick='javascript: " + this.obj + ".checkNode(" + node.id + "," + node.pid + "," + node._hc + "," + "\"" +node.cshow + "\"" + ",this.checked);' ";
            }
            else {
    ...
    str += '</div>';
    if (node._hc) {
        str += '<div id="d' + this.obj + nodeId + node.pid+ '" class="clip" style="display:' + ((this.root.id == node.pid || node._io) ? 'block' : 'none') + ';">';
...
dTree.prototype.indent = function (node, nodeId) {
    ...
    if (this.root.id != node.pid) {
        ...
        if (node._hc) {
            str += '<a href="javascript: ' + this.obj + '.o(' + node.pid+','+ nodeId+ ');"><img id="j' + this.obj + nodeId + node.pid+ '" src="';
...
dTree.prototype.s = function (pid, id) {
...
dTree.prototype.o = function (pid,id) {
    var cn = this.aNodes[id];
    this.nodeStatus(!cn._io, id, cn._ls, pid);
    cn._io = !cn._io;
...
dTree.prototype.nodeStatus = function (status, id, bottom,pid) {
    eDiv = document.getElementById('d' + this.obj + id +pid);
    eJoin = document.getElementById('j' + this.obj + id +pid);
    if (this.config.useIcons) {
