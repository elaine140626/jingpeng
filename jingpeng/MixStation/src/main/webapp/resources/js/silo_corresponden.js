...
var bunk = {
    ...
    $.ajax({
        type: "post",
        url: "../cement_Production/getcementBunkerValue",
        data:{},
        async:false,
        dataType: "json",
...
//    })
    ...
    $('#bunk').DataTable({
        ...
        "ajax" : "../cement_Production/getBunker_Correspondences?i_org_Id="+i_org_Id,
        "deferRender" : true,
        "columns" : [{
            "data" : "serialNumber"
        }, {
    ...
    $('#Bunker_code').blur(function(){
        $.ajax({
            type: "post",
            async: false,
            url: "../cement_Production/getBunker_CorrespondenceByCode",
            dataType: "json",
            contentType : 'application/json;charset=UTF-8',
    ...
    $("#btnbunk").on("click",function () {
        ...
        $.ajax({
            type: "post",
            url: "../cement_Production/addBunker_Correspondence",
            ...
            success: function (data) {
            	if(data.code=="success"){
    				...
    				function(){
    					window.location.href=baseUrl + "/cement_Production/silo_correspondence.html";
    				});
...
function getSgpb(){
   ...
   $.ajax({
       type: "post",
       url: "../CementConstructionProp/getCementConstructionPropbypids",
...
function getStrNmae(obj){
	...
	$.ajax({
        type: "post",
        async: false,
        url: "../CementTheory/getYclList.html",
        dataType: "json",
	...
	$.ajax({
        type: "post",
        async: false,
        url: "../CementTheory/getAllMaterials_id.html",
        dataType: "json",
...
function getStrModels(obj,name){
	...
	$.ajax({
        type: "post",
        async: false,
        url: "../CementTheory/getYclModelList.html",
        data: params,
        dataType: "json",
        success: function (data) {
        	strModels = "";
...
function getSilo_correspondenceSelect(){
	...
	$('#bunk').DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../cement_Production/getBunker_Correspondences",
            dataSrc: "data",
            data: function (d) {
                var param = {};
