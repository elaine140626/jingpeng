...
function getC_ProductiondataSelect(){
	...
	$('#cement_ProductionDatas').DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../cementProductionData/getCement_ProductionDatas.action",
            dataSrc: "data",
            data: function (d) {
                var param = {};
...
function getList() {
    ...
    $("#cement_ProductionDatas").DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../cementProductionData/getCement_ProductionDatas.action?i_org_Id="+i_org_Id,
            dataSrc: "data",
            data: function (d) {
                var param = {};
...
function getcollect_Date(i_id) {
    ...
    $("#cemdtel").DataTable({
        ...
        "ajax" : {
            type: "post",
            url: "../Cement_ProductionDetailed/getCement_ProductionDetaileds.action",
            dataSrc: "data",
            data: function (d) {
                var param = {};
