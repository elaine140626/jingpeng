...
function getList() {
	$('#list').DataTable({
		...
		"ajax" : baseUrl + "/AsphaltProduceStatistic/getAsphaltProduceStatistic.action?i_org_Id="+i_org_Id,
		"deferRender" : true,
		"columns" : [ 
			{"data" : "serialNumber"},
			{"data" : "collect_Time"},
...
function getBar(param) {
	...
	$.ajax({
		type : "POST",
		url : baseUrl + "/AsphaltProduceStatistic/getBar.action", 
		data :  param,
		dataType : "json",
		success : function(data) {
			var str = "{"
...
function search() {
	...
	$('#list').DataTable({
		...
		"ajax" : {
            type: "post",
            url: baseUrl + "/AsphaltProduceStatistic/getAsphaltProduceStatistic.action",
            dataSrc: "data",
            data: function (d) {
