    ...
    $(".btncha").on("click",function () {
        ...
        $("#cement_ProductionDatas").DataTable({
            ...
            "createdRow": function (row, data, dataIndex) {
                ...
                /*if(data.i_analysis_Results_Cement == 0){
                ...
                if(data.i_analysis_Results_Aggregate == 0){
                ...
                if(data.i_analysis_Results_Water == 0){
                    $('td:eq(15)', row).attr("class","warn2")
                }
                if(data.i_analysis_Results_Admixture == 0){
                    $('td:eq(16)', row).attr("class","warn2")
                    $('td:eq(17)', row).attr("class","warn2")
                }*/

                $(row).children("td").eq(5).text(Number(data.d_weight_Cement1).toFixed(2));
                $(row).children("td").eq(6).text(Number(data.d_weight_Cement2).toFixed(2));
                $(row).children("td").eq(7).text(Number(data.d_weight_Cement3).toFixed(2));
                $(row).children("td").eq(8).text(Number(data.d_weight_Cement4).toFixed(2));
                $(row).children("td").eq(9).text(Number(data.d_weight_Aggregate1).toFixed(2));
                $(row).children("td").eq(10).text(Number(data.d_weight_Aggregate2).toFixed(2));
                $(row).children("td").eq(11).text(Number(data.d_weight_Aggregate3).toFixed(2));
                $(row).children("td").eq(12).text(Number(data.d_weight_Aggregate4).toFixed(2));
                $(row).children("td").eq(13).text(Number(data.d_weight_Aggregate5).toFixed(2));
                $(row).children("td").eq(14).text(Number(data.d_weight_Aggregate6).toFixed(2));
                $(row).children("td").eq(15).text(Number(data.d_weight_Water).toFixed(2));
                $(row).children("td").eq(16).text(Number(data.d_weight_Admixture1).toFixed(2));
                $(row).children("td").eq(17).text(Number(data.d_weight_Admixture2).toFixed(2));
                $(row).children("td").eq(18).text(Number(data.d_total_Weight).toFixed(2));
