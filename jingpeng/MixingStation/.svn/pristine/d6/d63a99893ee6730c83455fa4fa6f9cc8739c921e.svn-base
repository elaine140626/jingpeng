...
$(function () {
 ...
 function getList() {
        ...
        $("#Statistics").DataTable({
            ...
            "ajax" : "../cementProductionData/getcement_ProductionStatisti.action?i_org_Id="+i_org_Id,
            "deferRender" : true,
            "columns" : [ {
                "data" : "serialNumber"
            }, {
...
function getCement_ProductionStatisticSelect(){
	...
	$('#Statistics').DataTable({
        ...
        "ajax" : {
            type: "post",
            url : baseUrl + "/cementProductionData/getcement_ProductionStatisti.action", 
            dataSrc: "data",
            data: function (d) {
...
function getBar(param) {
	...
	$.ajax({
		type : "POST",
		url : baseUrl + "/cementProductionData/getBar.action", 
		data :  param,
		dataType : "json",
		success : function(data) {
			console.log(data);
