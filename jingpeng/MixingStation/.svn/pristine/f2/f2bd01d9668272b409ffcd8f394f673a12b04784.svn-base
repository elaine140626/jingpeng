...
function dTree(objName, objbool) {        // void ���췽��������������objName: �����ơ�objbool����ѡ��ѡ true��ѡ  false��ѡ  Ĭ�ϵ�ѡ         
    ...
    this.icon = {
        root:        'img/base.gif',         // Node ���ڵ㡣 
        folder:      'img/folder.gif',       // Node ���ڵ㡣 
        folderOpen:  'img/folderopen.gif',   // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        node:        'img/page.gif',         // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        empty:       'img/empty.gif',        // �򿪵��ļ���,Ĭ��'img/folderOpen.gif' 
        line:        'img/line.gif',         // ����,Ĭ��'img/line.gif'
        join:        'img/join.gif',         // ����,Ĭ��'img/join.gif' 
        joinBottom:  'img/joinbottom.gif',   // ֱ����,Ĭ��'img/joinbottom.gif' 
        plus:        'img/plus.gif',         // �ӺŶ���,Ĭ��'img/plus.gif' 
        plusBottom:  'img/plusbottom.gif',   // �Ӻ�ֱ����,Ĭ��'img/plusbottom.gif' 
        minus:       'img/minus.gif',        // ���Ŷ���,Ĭ��'img/minus.gif' 
        minusBottom: 'img/minusbottom.gif',  // ����ֱ����,Ĭ��'img/minusbottom.gif'  
        nlPlus:      'img/nolines_plus.gif', // ����ֱ����,Ĭ��'img/minusbottom.gif' 
        nlMinus:     'img/nolines_minus.gif' //���߼���,Ĭ��'img/nolines_minus.gif' 
    };
