...
$(function(){
	...
	$.ajax({
		type : "POST",
		url : "../../WeighingQuery/getInWeighingInfoCount.action",
		async:false,
		data : {"type":"RK"},
		dataType : "json",
...
//止运地赋值
function changReceiveUnit(){
	var index=document.getElementById("receiveUnitId").selectedIndex;
	var endAddress = document.getElementById("receiveUnitId").options[index].text;
...
function getListInfo(){
	$.ajax({
		type : "POST",
		url : "../../WeighingQuery/getInFeedCompanyInfo.action",
		async:false,
		data : {},
		dataType : "json",
		success : function(data) {
...
function save(){
	...
	$.ajax({
		type: 'POST',
		url: '../../WeighingQuery/addExportMeasureIn.action',
