...
public class PlatformAsphaltWarningInformationEntity {
	...
	private String LQUnqualified;// 沥青
	...
	public String getLQUnqualified() {
		return LQUnqualified;
	}

	public void setLQUnqualified(String lQUnqualified) {
