...
public class ShiYan07Entity {
	...
	private String AvgYieldStrth; // 平均屈服强度(MPa)
	private String AvgTensileStrength; // 平均抗拉强度（Mpa)
	private String YieldStrth; // 判定指标(屈服强度)
	...
	public String getAvgYieldStrth() {
		return AvgYieldStrth;
	}
	public void setAvgYieldStrth(String avgYieldStrth) {
		AvgYieldStrth = avgYieldStrth;
	}
	...
	public String getYieldStrth() {
		return YieldStrth;
	}
	public void setYieldStrth(String yieldStrth) {
		YieldStrth = yieldStrth;
	}
