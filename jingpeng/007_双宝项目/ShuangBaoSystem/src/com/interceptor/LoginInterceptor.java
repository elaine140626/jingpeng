...
public class LoginInterceptor implements HandlerInterceptor{	
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (reqUrl.endsWith("UserInfo/userLogin.action") || reqUrl.endsWith("UserInfo/getTestRoomList.action") 
				|| reqUrl.endsWith("UserInfo/getOrgInfoList.action")|| reqUrl.endsWith("UserInfo/insertUserInfo.action")
				|| reqUrl.contains("FluorescentCloud")|| reqUrl.contains("Jpush/jpush.action")) {
			// 平台拦截器
			return true;
		} else if (reqUrl.endsWith("login/userLogin.action") || reqUrl.endsWith("login/getOrg.action") || reqUrl.endsWith("login/addUser.action")) {
			// 拌合站拦截器
			return true;
		} else if (reqUrl.endsWith("VideoSurveillance/getTestInfoCount.action") || reqUrl.endsWith("VideoSurveillance/getAutoCollectionCount.action") 
				|| reqUrl.endsWith("VideoSurveillance/getBlindCount.action")|| reqUrl.endsWith("VideoSurveillance/getAutoCollectionList.action")
				|| reqUrl.endsWith("VideoSurveillance/getBlindList.action")) {
			// 大屏
			return true;
		} else if (reqUrl.endsWith("ConstructionProgress/getAppRoadByUniqueIdentifier.action") 
				|| reqUrl.endsWith("ConstructionProgress/getAppBridgeByRoad.action")) {
			// App
			return true;
