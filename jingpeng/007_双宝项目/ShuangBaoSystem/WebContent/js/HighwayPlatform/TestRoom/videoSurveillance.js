...
/*	
   ...
   $.ajax({
        ...
        dataType: "json",
        success: function (data) {
//        	data =[{"UniqueIdentifier":"SS1","TestRoomName":"S1中心试验室","dCount":"454"},
//        		{"UniqueIdentifier":"SA1","TestRoomName":"A1标段试验室","dCount":"486"},
//        		{"UniqueIdentifier":"SA2","TestRoomName":"A2标段试验室","dCount":"523"},
//        		{"UniqueIdentifier":"SS2","TestRoomName":"S2中心试验室","dCount":"556"},
//        		{"UniqueIdentifier":"SA3","TestRoomName":"A3标段试验室","dCount":"496"},
//        		{"UniqueIdentifier":"SA4","TestRoomName":"A4标段试验室","dCount":"563"},]
            var html = "";
        	if(data != null && data.length > 0){
        		for(var i = 0; i < data.length; i++){     			
        			html += "<div id='count"+(i+1)+"'>"
					        ...
					        + "<li>试验总数：<span>"+data[i].dCount+"</span></li>"
...
//					        + "<li>盲样试验数：<span>"+data[i].mCount+"</span></li>"
        			...
        			// 动态赋值
        		    var item={
        		    		product: data[i].TestRoomName.substring(0,2),
        					'试验总数': data[i].dCount,
...
function getAutoCollectionCount(){
	$.ajax({
        ...
        dataType: "json",
        success: function (data) {
//		var data = [{"UniqueIdentifier":"SS1","TestRoomName":"S1中心试验室","zdCount":"454","hgCount":"446"},
//			{"UniqueIdentifier":"SA1","TestRoomName":"A1标段试验室","zdCount":"486","hgCount":"477"},
//			{"UniqueIdentifier":"SA2","TestRoomName":"A2标段试验室","zdCount":"523","hgCount":"515"},
//			{"UniqueIdentifier":"SS2","TestRoomName":"S2中心试验室","zdCount":"556","hgCount":"547"},
//			{"UniqueIdentifier":"SA3","TestRoomName":"A3标段试验室","zdCount":"496","hgCount":"487"},
//			{"UniqueIdentifier":"SA4","TestRoomName":"A4标段试验室","zdCount":"563","hgCount":"553"},];
...
//						 + "<div class='icon_half'></div>"
						 + "<span class='i1'>自动采集合格率：</span><span class='i2'>"+percentNum(data[i].hgCount,data[i].zdCount)+"</span>"
						 + "</div>"
//						 + "</div>"
						 + "<div class='noIconz-pie'>"
						 + "<span class='i1'>自动采集总数量：</span><span class='i3'>"+data[i].zdCount+"</span>"
						 + "</div>"
						 + "<div class='noIconz-pie'>"
