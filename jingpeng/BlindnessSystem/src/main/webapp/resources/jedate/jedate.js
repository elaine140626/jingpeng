	...
	*/
    ...
    InitDate.prototype = {
        ...
        setHtml:function(opts, self) {
            ...
            var bothmsStr = !isformat ? '<ul class="botflex jedatehms"></ul>' + '<div class="botflex jedatebtn"><span class="jedateclear" style="width:31%;">清空</span><span class="jedateok" style="width:31%;">确认</span><span class="jedatetodaymonth" style="width:31%;">今天</span></div>' :'<div class="botflex jedatebtn"><span class="jedateclear" style="width:31%;">清空</span><span class="jedatetodaymonth" style="width:31%;">本月</span><span class="jedateok" style="width:31%;">确认</span></div>';
            var datebotStr = '<div class="jedatebot">' + bothmsStr + "</div>";//<li><em data-hms="24"></em><i>:</i></li><li><em data-hms="60"></em><i>:</i></li><li><em data-hms="60"></em></li>
