...
// 修改
function update(firstAsphaltSupplyId){
	var index = layer.open({
		type: 2,
		title: '修改沥青采购',
		content: 'asphaltPurchasing_add.html?firstAsphaltSupplyId='+firstAsphaltSupplyId+"&flag=1",
	});
	layer.full(index);
}

// 查看
function check(firstAsphaltSupplyId){
	var index = layer.open({
		type: 2,
		title: '查看沥青采购',
		content: 'asphaltPurchasing_add.html?firstAsphaltSupplyId='+firstAsphaltSupplyId+"&flag=0",
	});
	layer.full(index);
}