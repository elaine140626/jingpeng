...
$(function(){
	...
	if (id != null && id != ""){
		...
		$.ajax({
			type : "post",
			url : "../../RoadSurfaceNumber/getRoadSurfaceNumberById.action",
			data : {"id" : id},
			dataType : "json",
...
function save(){	
	...
	if (id == null){
		// 新增
		url = '../../RoadSurfaceNumber/insertRoadSurfaceNumber.action';
		params.projectId = ProjectId;
		params.creater=userId;
	} else {
		if (flag == 1){
			// 修改
			url = '../../RoadSurfaceNumber/updateRoadSurfaceNumber.action';
			params.id = id;
