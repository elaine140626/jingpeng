...
$(function(){
	...
	if (id != null && id != ""){
		...
		$.ajax({
			type : "post",
			url : "../../PipeCulvertNumber/getPipeCulvertNumberById.action",
			data : {"id" : id},
			dataType : "json",
...
function save(){	
	...
	if (id == null){
		// 新增
		url = '../../PipeCulvertNumber/insertPipeCulvertNumber.action';
		params.projectId = ProjectId;
		params.creater=userId;
	} else {
		if (flag == 1){
			// 修改
			url = '../../PipeCulvertNumber/updatePipeCulvertNumber.action';
			params.id = id;
