...
$(function(){
	...
	if (id != null && id != ""){
		...
		$.ajax({
			type : "post",
			url : "../../SupervisionApplication/selectFileList.action",
			data : {"id" : id},
			dataType : "json",
...
function delOrDownImage(count){
	...
	if(count == 1){
		url =  "../../SupervisionApplication/delUploadfile.action";
	}else{
		window.location.href = "../../SupervisionApplication/downUploadfile.action?imageNamePrams=" + imageNameStringList+"&imagePrefix="+imagePrefix;
